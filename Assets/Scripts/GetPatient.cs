...
public class GetPatient : MoveAction
{
    ...
    public override bool PrePerform() {
        ...
        if (resource != null) {
            ...
            GameManager.Instance.AddPatient(target);
            target = null;
            return false;
        }
